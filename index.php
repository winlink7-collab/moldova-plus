    ...
    <div class="deal-banner reveal">
      ...
      <div class="deal-visual">
        ...
        <div class="deal-badge-float">
          <span class="deal-pct">35%</span>
          <span class="deal-off he">הנחה</span>
          <span class="deal-off en">OFF</span>
        </div>
      </div>
      ...
      <div class="deal-info">
        <div class="deal-eyebrow">
          ...
          <span class="he">מבצע השבוע — מוגבל ל-12 מקומות</span>
          <span class="en">Deal of the week — limited to 12 spots</span>
        </div>

        <h2 class="deal-title">
          <span class="he">חופשת יין וספא קישינב — 4 לילות</span>
          <span class="en">Wine & Spa Chișinău — 4 nights</span>
        </h2>

        <p class="deal-desc">
          <span class="he">חבילה זוגית פרמיום: מלון 5 כוכבים, סיור יקב פרטי עם טעימות, ספא יום מלא, ארוחות בוקר וליווי מקומי אישי דובר עברית.</span>
          <span class="en">Premium couples package: 5-star hotel, private winery tour with tastings, full-day spa, breakfasts and personal Hebrew-speaking local guide.</span>
        </p>
        ...
        <ul class="deal-includes">
          <li>
            ...
            <span class="he">מלון Leogrand 5★ — 4 לילות</span><span class="en">Leogrand Hotel 5★ — 4 nights</span>
          </li>
          <li>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12l5 5L20 7"/></svg>
            <span class="he">סיור יקב מילשטיין עם טעימות</span><span class="en">Milshtein Winery tour with tastings</span>
          </li>
          <li>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12l5 5L20 7"/></svg>
            <span class="he">ספא יום מלא לזוג</span><span class="en">Full-day couples spa</span>
          </li>
          <li>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12l5 5L20 7"/></svg>
            <span class="he">ארוחות בוקר + ליווי עברית</span><span class="en">Breakfasts + Hebrew guide</span>
          </li>
        </ul>
        ...
        <div class="deal-price-row">
          <div class="deal-price">
            <span class="deal-price-was">
              <span class="he">במקום</span><span class="en">Was</span>
              €470
            </span>
            <div class="deal-price-now">
              <span class="deal-from he">מ-</span>
              <span class="deal-from en">from </span>
              <b>€299</b>
              <span class="deal-pp">/<span class="he">אדם</span><span class="en">pp</span></span>
            </div>
          </div>
          <div class="deal-spots">
            <div class="deal-spots-bar"><div class="deal-spots-fill" style="width:65%"></div></div>
            <span class="he">נותרו 4 מקומות</span>
            <span class="en">4 spots left</span>
          </div>
        </div>

        <!-- CTA -->
        <div class="deal-actions">
          <a href="https://wa.me/972355501880?text=<?= urlencode($lang==='he' ? 'היי, אני מעוניין בחבילת מבצע השבוע — יין וספא קישינב 4 לילות' : "Hi, I'm interested in the deal of the week — Wine & Spa Chișinău 4 nights") ?>" target="_blank" rel="noopener" class="btn btn-primary btn-lg">
        ...
        <p class="deal-timer">
          ...
          <span class="he">המבצע מסתיים בעוד:</span>
          <span class="en">Deal ends in:</span>
