...
$T = [
  ...
  'ru' => [
    'nights'  => 'ночей',
    'from'    => 'от',
    'nav'     => ['home'=>'Главная','packages'=>'Туры','bachelor'=>'Мальчишники','attractions'=>'Достопримечательности'],
    'hero'    => [
      'kicker'   => '#1 туры в Молдову',
      'h1'       => ['Молдова —', 'начни отсюда.'],
      'sub'      => 'Крупнейший портал туров в Кишинёв — мальчишники, люкс и лучшие винодельни. Прозрачные цены, мгновенное подтверждение.',
      'pkgs'     => '1,200+ туров',
      'verified' => 'Проверенные отзывы',
      'best'     => 'Лучшая цена',
    ],
    'search'  => ['where'=>'Куда?','whereV'=>'Кишинёв, Молдова','when'=>'Когда?','whenV'=>'Добавить даты','who'=>'Гостей','whoV'=>'2 гостя','type'=>'Тип тура','typeV'=>'Все','go'=>'Поиск'],
    'foot'    => [
      'about' => 'Крупнейший портал туров в Молдову. Каждый тур проверен — ненадёжные объекты удаляются.',
      'copy'  => '© 2026 Moldova Plus · Все права защищены',
    ],
  ],
];
...
$PACKAGES = [
  [
    'id'=>1,'slug'=>'romance-nobil-boutique','page'=>'vacation','type'=>'couples','price'=>890,'discount'=>12,'nights'=>4,'people_he'=>'2 אורחים','people_en'=>'2 guests','rating'=>'9.6','tag_he'=>'הכי פופולרי','tag_en'=>'Most popular','status'=>'now','scene'=>'warm',
  ...
  [
    'id'=>2,'slug'=>'ultimate-bachelor-party','page'=>'bachelor','type'=>'bach','price'=>650,'discount'=>8,'nights'=>3,'people_he'=>'8-12 אורחים','people_en'=>'8-12 guests','rating'=>'9.9','tag_he'=>'BEST SELLER','tag_en'=>'BEST SELLER','status'=>'now','scene'=>'dark',
  ...
  [
    'id'=>3,'slug'=>'wine-trail-cricova-milestii','page'=>'vacation','type'=>'wine','price'=>740,'discount'=>0,'nights'=>5,'people_he'=>'2-4 אורחים','people_en'=>'2-4 guests','rating'=>'9.4','tag_he'=>'','tag_en'=>'','status'=>'now','scene'=>'gold',
  ...
  [
    'id'=>4,'slug'=>'ultimate-luxury-presidential-suite','page'=>'vacation','type'=>'lux','price'=>1290,'discount'=>10,'nights'=>5,'people_he'=>'2 אורחים','people_en'=>'2 guests','rating'=>'9.8','tag_he'=>'','tag_en'=>'','status'=>'now','scene'=>'blue',
  ...
  [
    'id'=>5,'slug'=>'group-package-company-family','page'=>'bachelor','type'=>'group','price'=>520,'discount'=>0,'nights'=>3,'people_he'=>'10-20 אורחים','people_en'=>'10-20 guests','rating'=>'9.2','tag_he'=>'','tag_en'=>'','status'=>'day','scene'=>'light',
  ...
  [
    'id'=>6,'slug'=>'gastro-tour-chef-restaurants','page'=>'vacation','type'=>'food','price'=>680,'discount'=>15,'nights'=>4,'people_he'=>'2 אורחים','people_en'=>'2 guests','rating'=>'9.5','tag_he'=>'חדש','tag_en'=>'New','status'=>'now','scene'=>'gold',
  ...
  [
    'id'=>7,'slug'=>'spa-nature-codru-forest','page'=>'vacation','type'=>'spa','price'=>560,'discount'=>0,'nights'=>3,'people_he'=>'2 אורחים','people_en'=>'2 guests','rating'=>'9.3','tag_he'=>'','tag_en'=>'','status'=>'now','scene'=>'green',
  ...
  [
    'id'=>8,'slug'=>'adrenaline-karting-atv-shooting','page'=>'bachelor','type'=>'adv','price'=>480,'discount'=>0,'nights'=>3,'people_he'=>'4-8 אורחים','people_en'=>'4-8 guests','rating'=>'9.0','tag_he'=>'','tag_en'=>'','status'=>'day','scene'=>'dark',
  ...
  [
    'id'=>9,'slug'=>'honeymoon-package','page'=>'vacation','type'=>'couples','price'=>1090,'discount'=>18,'nights'=>6,'people_he'=>'2 אורחים','people_en'=>'2 guests','rating'=>'9.9','tag_he'=>'ירח דבש','tag_en'=>'Honeymoon','status'=>'now','scene'=>'honey',
