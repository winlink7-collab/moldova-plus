...
<header class="site-header" id="site-header">
  <div class="container site-inner">
    <!-- Logo -->
    <a href="/<?= $lang==='en'?'?lang=en':'' ?>" class="logo">
    ...
    <nav class="primary-nav">
      <a href="/<?= $lang==='en'?'?lang=en':'' ?>" class="<?= $page==='home'?'active':'' ?>">
...
<div class="mob-nav" id="mob-nav">
  <div class="mob-nav-top">
    <a href="/<?= $lang==='en'?'?lang=en':'' ?>" class="mob-logo">
      <span class="logo-mark">M+</span>
      <span>Moldova Plus</span>
    </a>
    <button class="mob-close" id="mob-close" aria-label="<?= $lang==='he'?'סגור':'Close' ?>">
